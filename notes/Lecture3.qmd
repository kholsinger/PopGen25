...
sim1 = [WrightFisher(1000,0.0,100000,0.000001;every=1000) for _ in 1:1000]
sim2 = [WrightFisher(1000,0.0,100000,0.000001;every=1000) for _ in 1:1000]
...
Just the probability that if two alleles grabbed at random mismatch.
...
How is variation partition w/in populations vs between?
...
So, can estimate divergence at sites using $F_{ST}$, can look for variation in genome.
