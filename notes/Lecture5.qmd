...
The simplest approaches here (STRUCTURE), have the user specify a number of groups (denoted as $K$), and try large numbers of assignments for all individuals to find the one that minimizes the departure from HW in all of the groups.
...
Further, there is no perfect way of knowing $K$.
...
theme(:solarized)
default(xlabelfontsize=16,ylabelfontsize=16,dpi=400,size=(1000,600),margins=4mm)
