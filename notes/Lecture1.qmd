...
Let's add the running mean to the plot to see how it behaves:
...
p2 = scatter(test,leg=false,xlabel=L"p_t",ylabel=L"|p_{t+1}-p_t|")
...
p1 = plot(transpose(Matrix(yeast_data[:,9:33])),leg=false,xlabel="Generation",ylabel=L"p_t",margin=5mm)
