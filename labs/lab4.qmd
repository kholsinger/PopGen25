...
If what you do is just `na.omit` each site, you will end up with the wrong LD values for i vs j comparisons, and site 3 is liable to break completely. So, you'll have to think of how to do this comparison differently than when we calculated allele frequencies.
...
### The combinatorial nightmare of LD
