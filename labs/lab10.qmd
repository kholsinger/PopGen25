...
![![](images/paste-7.png)](images/paste-6.png){width="582"}
...
Here, you do need to specify the per generation mutation rate, but the number of bins is estimated for you. This